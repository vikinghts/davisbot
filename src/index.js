async function amazonLamdbaRunner() {
  var event = {   
    ...
    "body": "{\"type\":\"override\",\"event\":\"fullTextInterception\",\"user\":\"mark.linders@planonsoftware.com\",\"payload\":{\"text\":\"cockpit\"}}",
    "isBase64Encoded": false   
  };
  //All the options
  //"body": "{\"type\":\"override\",\"event\":\"fullTextInterception\",\"user\":\"mark.linders@planonsoftware.com\",\"payload\":{\"text\":\"cockpit\"}}",
  //"body": "{\"type\":\"override\",\"event\":\"fullTextInterception\",\"user\":\"mark.linders@planonsoftware.com\",\"payload\":{\"text\":\"help\"}}",
  //"body": "{\"type\":\"override\",\"event\":\"fullTextInterception\",\"user\":\"mark.linders@planonsoftware.com\",\"payload\":{\"text\":\"no\"}}",
    ...
    async function handleCommands(payload) {
      switch(payload.text) {
        ...
        case 'no':
            ...
            break;
        case 'help':
            return '{"text": "Calling help will not help you!"}';
            break;
        default:
            return '{"text": "Sorry, I don`t know: ' + body.payload.text + '."}';
      }
    }
